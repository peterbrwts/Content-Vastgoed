...
export default function KopenOverview({ kopen }: { kopen: Kopen }) {
  return (
    <Section>
      <Container>
        ...
        {/* Fixed contact block */}
        <div className="text-white fixed right-4 bottom-4 bg-primary border border-primary shadow-lg p-4 rounded-lg z-10">
